    ...
    <section class="hero">
        <div class="container hero__grid">
            <div class="hero__copy">
                ...
                <p class="lead">Statosy helps teams ship reliable cloud services and software products with strong
                    security, high availability, and fast iteration.</p>
                <div class="hero__cta">
                ...
                <div class="panel">
                    ...
                    <div class="panel__graph">
                        <svg viewBox="0 0 640 220" role="presentation" focusable="false">
                            ...
                            fill="none" stroke="url(#g)" stroke-width="4" filter="url(#blur)" />
                            <path <div class="panel__meta">
                                <div class="meta">
    ...
    <section class="section" id="process">
        <div class="container">
            <div class="section__head">
                ...
                <p class="muted">Statosy partners with you through strategy, build, and operations to keep your services
        ...
        <div class="container">
            <div class="impact">
                <div class="impact__copy">
                    ...
                    <p class="muted">Statosy brings engineering depth and operational discipline to help you reach digital
                        transformation through secure, scalable, and maintainable systems.</p>
