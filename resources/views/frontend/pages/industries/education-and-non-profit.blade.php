    ...
    <section class="hero">
        <div class="container hero__grid">
            <div class="hero__copy">
                <h1 class="h1">{{ \App\Support\SiteContentStore::get('industries.education-and-non-profit.hero.title', $title ?? 'Education And Non-Profit') }}</h1>
                <p class="lead">
                    {{ \App\Support\SiteContentStore::get('industries.education-and-non-profit.hero.text', 'Dependable software for education and non-profit organizations—secure access, stable performance, and simplified operations designed for mission-driven teams.') }}
                </p>
                <div class="hero__cta">
                    <a class="btn btn--primary"
                        href="{{ route('contact-us') }}#message">{{ \App\Support\SiteContentStore::get('industries.education-and-non-profit.hero.cta.primary', 'Send a message') }}</a>
                    <a class="btn btn--ghost"
                        href="{{ route('contact-us') }}#schedule">{{ \App\Support\SiteContentStore::get('industries.education-and-non-profit.hero.cta.secondary', 'Schedule a meeting') }}</a>
                </div>
            </div>
