    ...
    <section class="hero">
        <div class="container hero__grid">
            <div class="hero__copy">
                <h1 class="h1">{{ \App\Support\SiteContentStore::get('solutions.it-consulting.hero.title', $title ?? 'IT Consulting') }}</h1>
                <p class="lead">
                    {{ \App\Support\SiteContentStore::get('solutions.it-consulting.hero.text', 'Your IT problems solved with tailored solutions and practical digital innovation. We help you make better decisions, implement the right solutions, and keep delivery grounded in real business goals.') }}
                </p>
                <div class="hero__cta">
                    <a class="btn btn--primary"
                        href="{{ route('contact-us') }}#message">{{ \App\Support\SiteContentStore::get('solutions.it-consulting.hero.cta.primary', 'Send a message') }}</a>
                    <a class="btn btn--ghost"
                        href="{{ route('contact-us') }}#schedule">{{ \App\Support\SiteContentStore::get('solutions.it-consulting.hero.cta.secondary', 'Schedule a meeting') }}</a>
                </div>
            </div>
